...
namespace ApiModel.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<IdentityUser> userManager, JwtSettings jwtSetttings, TokenValidationParameters tokenValidationParameters, DataContext context)
        {
